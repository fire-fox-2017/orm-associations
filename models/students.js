  ...
  var Student = sequelize.define('Student', {
    ...
    classMethods: {
      associate: function(models) {
        ...
        Student.belongsToMany(models.Teacher, {through: models.StudentTeacher, foreignKey: "student_id"});
      },
      getAllData: function(callback) {
        ...
        delete: function(id) {
          Student.destroy({where : {"id": id}})
            .then((destroyed) => {
              if(destroyed > 0) {
                console.log(`Removed Student with id ${id} from table, ${destroyed} data deleted`);
              } else {
